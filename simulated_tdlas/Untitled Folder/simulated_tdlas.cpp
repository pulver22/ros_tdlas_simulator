...
//pararmeters
  ...
  n.getParam("/simulated_tdlas/sensor0_model",sensor0_model);
  n.getParam("/simulated_tdlas/sensor1_model",sensor1_model);
  n.getParam("/simulated_tdlas/sensor2_model",sensor2_model);
